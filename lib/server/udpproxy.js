...
var Proxy = exports.Proxy = (function() {
  ...
  var _handleClient = function(client) {
    ...
    client.on('packet', function(packet) {
      ...
      var rpc = packet.msg;
      var id  = new Buffer(crypto.hexToAscii(crypto.digest.SHA1(self._extractip_port())), 'ascii');
      ...
      switch (rpc.method) {
        case 'FIND_NODE':
          var target = new Buffer(crypto.hexToAscii(rpc.params[0]), 'ascii');
          request.a = {
            id: id,
            target: target
          };
      ...
      request = bencode.encode(request, 'ascii');
