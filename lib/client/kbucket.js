...
(function(exports) {
  ...
  KadOH.KBucket = Class(
     ...
     * @constructs
     * @param  {Number} [min=1]       Lowlimit of this KBucket
     * @param  {Number} [max=globals._B]       Highlimit of this KBucket
     * @param  {PeerId} parent_id Id of the parent
     */
     ...
     * 
     * @param {Peer,String} peer the Peer or its ID
     ...
     * @param {String[]|Peer[]} exclude the id or peers to exclude
     * @return {Array}
     */
     ...
     *
     * @param {Object} range
     * @param {Number} range.min LowLimit of range
     * @param {Number} range.max HighLimit of range
     * @return {KBucket} self
     */
