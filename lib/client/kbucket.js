...
(function(exports) {
  ...
  KadOH.KBucket = Class(
     ...
     * @param  {Number} [min=0] - Min limit of this KBucket (exprimed as bit position)
     * @param  {Number} [max=globals._B] - Max limit of this KBucket (exprimed as bit position)
     */
    ...
    /**
     * Get an `Object` with the `min` and `max` values of the KBucket's range (exprimed as bit position).
     *
    ...
    /**
     * Set the range of the KBucket (exprimed as bit position)
     *
    ...
    /**
     * Set the range min of the KBucket (exprimed as bit position)
     *
    ...
    /**
     * Set the range max of the KBucket (exprimed as bit position)
     *
