...
(function(exports) {
  ...
  KadOH.KBucket = PeerArray.extend(
    ...
    touch: function() {
      ...
      var past = this._refreshTime && this._refreshTime < now;
      this._refreshTime = Math.floor((now + (past ? 0 : globals.TIMEOUT_REFRESH)) *
                                     (1 + globals.TIMEOUT_REFRESH_WINDOW * Math.random()));
