  ...
  KadOH.Node = StateEventEmitter.extend({
    ...
    join: function(bootstraps, callback, context) {
      ...
      var process = function() {
        ...
        return bootstrapping.then(startLookup, noBootstrap);
      };
      ...
      if (callback) {
        ...
        var failure = function() {
          ...
          callback.call(context, new Error('joined failed'));
        }
        this.once('joined', success, this)
            .once('joined failed', failure, this);
      }
      return process;
    },
