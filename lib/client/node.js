...
(function(exports) {
  ...
  KadOH.Node = Class({
    ...
    _iterativeFind: function(id) {
      ...
      seen = this._routing_table.getClosePeers(id, alpha);
    ...
    iterativeFindNode: function(id) {
      ...
      var iterate = new IterativeFind(this, id, 'FIND_NODE');
      iterate.startWith(seen);
