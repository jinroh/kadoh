...
(function(exports, Strophe) {
  ...
  KadOH.transport.XMPP = StateEventEmitter.extend({
    ...
    connect: function() {
      ...
      var onConnect = function(status, error) {
        switch (status) {
          ...
          case Strophe.Status.ATTACHED:
            self._setStropheConnectionIDs(self._jid, self._connection.sid, self._connection.rid);
      ...
      var prev_session = this._getStropheConnectionIDs(this._jid);
    ...
    _setStropheConnectionIDs: function(jid, sid, rid) {
      document.cookie = '_strophe_sid_'+jid+'='+String(sid);
      document.cookie = '_strophe_rid_'+jid+'='+String(rid);
    },

    _getStropheConnectionIDs: function(jid) {
      var sid_match = (new RegExp('_strophe_sid_'+jid+"=([^;]*)", "g")).exec(document.cookie);
      var rid_match = (new RegExp('_strophe_rid_'+jid+"=([^;]*)", "g")).exec(document.cookie);
