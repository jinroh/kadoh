  ...
  KadOH.rpc.Reactor = StateEventEmitter.extend({
    ...
    sendRPCQuery: function(rpc) {
      if (this.stateIsNot('connected')) {
        ...
        KadOH.log.info('Reactor', 'send query', rpc, rpc.normalizeQuery());
      }
      return this;
    },
    ...
    sendRPCResponse: function(rpc) {
      if(this.stateIsNot('connected')) {
        ...
        KadOH.log.info('Reactor', 'send response', rpc, rpc.normalizeResponse());
      }
      return this;
    },
    ...
    handleNormalizedQuery: function(query, from) {
      ...
      KadOH.log.info('Reactor', 'received query', from, query);
    ...
    handleNormalizedResponse: function(response, from) {
      ...
      if(!rpc) {
        ...
        KadOH.log.info('Reactor', 'received response', from, response);
