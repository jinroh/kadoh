...
(function(exports) {
  ...
  KadOH.rpc.object.RPCStub = Deferred.extend({
    ...
    _setResponseError: function(error) {
      this.response = {};
      this.response.error = error;
    },

    _addExtra: function(property, value) {
    ...
    _setResponseFromResolve: function() {
      var args = Array.prototype.slice.call(arguments);
      args = (args.length === 0) ? null : args;
      args = (args.length === 1) ? args[0] : args;
      this._setResponseResult(args);
    },

    _setResponseFromReject: function() {
      var args = Array.prototype.slice.call(arguments);
      args = (args.length == 1) ? args[0] : args;
      this._setResponseError(args);
    },
    ...
    resolve: function() {
      this._clearTimeout();
      this._setResponseFromResolve.apply(this, arguments);
    ...
    reject: function() {
      this._clearTimeout();
      this._setResponseFromReject.apply(this, arguments);
      this.supr.apply(this,arguments);
    },
