...
(function(exports) {
  ...
  KadOH.rpc.object.RPCStub = Deferred.extend({
    ...
    resolve: function() {
      this._clearTimeout();
      var res = this._getResultFromResolve.apply(this, arguments);
      this._setResponseResult(res);
    ...
    reject: function() {
      this._clearTimeout();
      var err = this._getErrorFromReject.apply(this, arguments);
      this._setResponseError(err);
      this.supr.apply(this,arguments);
    },
