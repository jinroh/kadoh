...
(function(exports) {
  ...
  KadOH.rpc.object.PingRPC = KadOH.rpc.object.RPC.extend({
  ...
  KadOH.rpc.object.FindNodeRPC = KadOH.rpc.object.RPC.extend({
  ...
  KadOH.rpc.object.FindValueRPC = KadOH.rpc.object.RPC.extend({
    ...
    handle: function(response) {
      this.supr(response, function(response) {
        ...
        if (result.value) {
          ...
          found = false;
          value = new PeerArray(peers);
        }
        
        this.resolve(value, found);
      });
    }
  });

  KadOH.rpc.object.StoreRPC = KadOH.rpc.object.RPC.extend({
