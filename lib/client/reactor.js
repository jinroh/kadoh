...
(function(exports) {
  ...
  KadOH.Reactor = EventEmitter.extend({
    ...
    initialize: function(node, options) {
      ...
      this._transport = new SimUDP(globals._transport_server, (options) ? options.transport : undefined);
    ...
    connectTransport : function() {
      ...
      // main listen loop
        self._transport.listen(bind(self._handler, self));
      });
    ...
    sendRPCs: function(dst_peer_array, method, params) {
      ...
      dst_peer_array.forEach(function(peer) {
        self.sendRPC(peer,method, params);
      });
    ...
    _handleRPC: function(src, request) {
      ...
      try {
        ...
        try {
          // call the RPC
          var result = method.apply(this._node, params);
