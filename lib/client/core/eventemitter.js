...
(function(exports) {
  ...
  var Event = KadOH.core.Event = function(options) {
    this.callbacks   = [];
    this.stack       = [];
    this.args        = null;
    this.firing      = false;
  ...
  Event.prototype.addListener = function(type, listener, scope, once) {
  ...
  Event.prototype.disable = function() {
    this.callbacks = this.stack = this.args = null;
    this.disabled  = true;
  };
  ...
  KadOH.core.EventEmitter = Class(
    ...
    addEvent: function(type, options) {
      if (this._events.hasOwnProperty(type)) {
        ...
        this._events[type] = new Event(options);
      }
    },
    ...
    on: function(type, listener, scope, once) {
      ...
      if (!events.hasOwnProperty(type)) {
        events[type] = new Event();
      }

      event = events[type];
      if (!event.disabled) {
        event.addListener(type, listener, scope, once);
      }
      return this;
    },
