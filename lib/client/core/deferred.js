  ...
  var Deferred = KadOH.core.Deferred = StateEventEmitter.extend({
    ...
    getResolvePassedArgs: function() {
      if(!this.isResolved())
        ...
        var args =  Array.prototype.slice.call(this._events.resolved.memory);
        args.shift();
        return args;
      }
    },
    ...
    getRejectPassedArgs: function() {
      if(!this.isRejected())
        throw new Error('Is not rejected');
      else {
        var args = Array.prototype.slice.call(this._events.rejected.memory);
        args.shift();
        return args;
      }
    },
