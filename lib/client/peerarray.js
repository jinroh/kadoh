...
// Extends Array.prototype
    ...
    map: function() {
      Array.prototype.map.apply(this._PEERS, arguments);
      return this;
    },

    reduce: function() {
      Array.prototype.reduce.apply(this._PEERS, arguments);
      return this;
    },

    some: function() {
      Array.prototype.some.apply(this._PEERS, arguments);
      return this;
    },

    every: function() {
      Array.prototype.every.apply(this._PEERS, arguments);
      return this;
    },

    filter: function() {
      Array.prototype.filter.apply(this._PEERS, arguments);
      return this;
    }
  ...
  var SortedPeerArray = KadOH.SortedPeerArray = PeerArray.extend({
    ...
    add: function(peers) {
      ...
      peers.forEach(function(peer) {
        self.addPeer(peer);
        new_closest = new_closest || this._newClosest;
      });
