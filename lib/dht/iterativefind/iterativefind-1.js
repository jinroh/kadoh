var Deferred           = require('../util/Deferred'),
    ...
    Peer               = require('../structure/Peer'),
    PeerArray          = require('../structure/PeerArray'),
    XORSortedPeerArray = require('../structure/XORSortedPeerArray');
...
var IterativeFind1 = module.exports = Deferred.extend({
  ...
  initialize: function(nodeInstance, target, targetType) {
    ...
    this.Reached    = new XORSortedPeerArray().setRelativeNodeID(this._target); // Peers queried that successfully responded
