...
(function(a){var b=a,c=b.core.Class;b.util={};var d=b.util.Crypto={};d.util=c().statics({rotl:function(a,b){return a<<b|a>>>32-b},rotr:function(a,b){return a<<32-b|a>>>b},endian:function(a){if(a.constructor==Number)return util.rotl(a,8)&16711935|util.rotl(a,24)&4278255360;for(var b=0;b<a.length;b++)a[b]=util.endian(a[b]);return a},randomBytes:function(a){for(var b=[];a>0;a--)b.push(Math.floor(Math.random()*256));return b},bytesToWords:function(a){for(var b=[],c=0,d=0;c<a.length;c++,d+=8)b[d>>>5]|=a[c]<<24-d%32;return b},wordsToBytes:function(a){for(var b=[],c=0;c<a.length*32;c+=8)b.push(a[c>>>5]>>>24-c%32&255);return b},bytesToHex:function(a){for(var b=[],c=0;c<a.length;c++)b.push((a[c]>>>4).toString(16)),b.push((a[c]&15).toString(16));return b.join("")},hexToBytes:function(a){for(var b=[],c=0;c<a.length;c+=2)b.push(parseInt(a.substr(c,2),16));return b},XOR:function(a,b){if(a.length!=b.length)return;a=util.hexToBytes(a),b=util.hexToBytes(b);var c=[];for(var d=0;d<key1.length;d++)c.push(key1[d]^key2[d]);return c},distance:function(a,b){if(a===b)return 0;a=d.util.hexToBytes(a),b=d.util.hexToBytes(b);var c=a.length;if(c!=b.length)return console.error("distance between two different sized key"),-1;var e=c*8-1;for(i=0;i<c;i++){var f=a[i]^b[i];if(f){for(var g=0;g<7;g++)if(f>>>7-g)break;return e-i*8-g}}return e}});var e=d.charenc={};d.charenc.Binary=c().statics({stringToBytes:function(a){for(var b=[],c=0;c<a.length;c++)b.push(a.charCodeAt(c)&255);return b},bytesToString:function(a){for(var b=[],c=0;c<a.length;c++)b.push(String.fromCharCode(a[c]));return b.join("")}}),d.charenc.UTF8=c().statics({stringToBytes:function(a){return Binary.stringToBytes(unescape(encodeURIComponent(a)))},bytesToString:function(a){return decodeURIComponent(escape(Binary.bytesToString(a)))}});var f=d.digest=c().statics({SHA1:function(a,b){var c=util.wordsToBytes(f._sha1(a));return b&&b.asBytes?c:b&&b.asString?Binary.bytesToString(c):util.bytesToHex(c)},_sha1:function(a){a.constructor==String&&(a=UTF8.stringToBytes(a));var b=util.bytesToWords(a),c=a.length*8,d=[],e=1732584193,f=-271733879,g=-1732584194,h=271733878,i=-1009589776;b[c>>5]|=128<<24-c%32,b[(c+64>>>9<<4)+15]=c;for(var j=0;j<b.length;j+=16){var k=e,l=f,m=g,n=h,o=i;for(var p=0;p<80;p++){if(p<16)d[p]=b[j+p];else{var q=d[p-3]^d[p-8]^d[p-14]^d[p-16];d[p]=q<<1|q>>>31}var r=(e<<5|e>>>27)+i+(d[p]>>>0)+(p<20?(f&g|~f&h)+1518500249:p<40?(f^g^h)+1859775393:p<60?(f&g|f&h|g&h)-1894007588:(f^g^h)-899497514);i=h,h=g,g=f<<30|f>>>2,f=e,e=r}e+=k,f+=l,g+=m,h+=n,i+=o}return[e,f,g,h,i]},_blocksize:16,_digestsize:20})})("object"==typeof module?module.exports:this.KadOH={})
